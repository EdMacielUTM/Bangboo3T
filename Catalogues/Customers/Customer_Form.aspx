<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Customer_Form.aspx.cs" Inherits="Bangboo3T.Catalogues.Customers.Customer_Form" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            ...
            <p>
                <asp:Button ID="Return" runat="server" Text="Return to Customers" CssClass="btn btn-primary btn-xs" Width="170px" OnClick="Return_Click" />
            </p>
        </div>
        <div class="row">
            <div class="col-md-12">
